...
\begin{tikzpicture}
  \pic at (0,0) {llnode=node_ptr/{}};

  \pic at (2,0) {llnode=new_node/{TAIL}};

  \node[DOTS] at (-1.75, 1.25) (prev NULL) {$\cdots$};

   \node[NULL] at (3.75, 0) (next NULL) {NULL};
  ...
  \draw[new link] (new_node data) -- (World);

  \draw[link] (node_ptr prev) -- (prev NULL);
  \draw[new link] (new_node next) -- (next NULL);
